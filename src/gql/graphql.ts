...
export type CategoryPartsFragment = {
  ...
  slug: string;
} & { " $fragmentName"?: "CategoryPartsFragment" };
...
export type CategoryQuery = {
  ...
  category: {
    ...
    restaruants?: Array<RestaurantPartsFragment> | null;
    category?: CategoryPartsFragment | null;
  };
};
...
export type RestaurantsPageQuery = {
  ...
  allCategories: {
    ...
    ok: boolean;
    error?: string | null;
    categories?: Array<CategoryPartsFragment> | null;
  };
  restaurants: {
    __typename?: "RestaurantsOutput";
    ok: boolean;
    ...
    totalPages?: number | null;
    totalResult?: number | null;
    results?: Array<RestaurantPartsFragment> | null;
  };
};
...
export type SerachRestaurantQuery = {
  __typename?: "Query";
  serachRestaurant: {
    __typename?: "SearchRestaurantOutput";
    ok: boolean;
  ...
  definitions: [
    {
      ...
      name: { kind: "Name", value: "RestaurantParts" },
      typeCondition: {
        kind: "NamedType",
...
} as unknown as DocumentNode<RestaurantPartsFragment, unknown>;
...
} as unknown as DocumentNode<CategoryPartsFragment, unknown>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "totalResult" } },
                {
                  kind: "Field",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "RestaurantsInput" },
            },
          },
        },
      ],
...
export const SerachRestaurantDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "serachRestaurant" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "SearchRestaurantInput" },
            },
          },
        },
      ],
  ...
  SerachRestaurantQuery,
  SerachRestaurantQueryVariables
>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "EditProfileInput" },
            },
          },
        },
      ],
